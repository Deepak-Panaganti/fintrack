...
//           "http://localhost:5000/api/insights/risk/1",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
//         setRisk(r.data);
...
//           "http://localhost:5000/api/insights/progress/1",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
//         setProgress(p.data);
...
//         <div className="card">
//           <h4>AI Risk Level</h4>
//           <p style={{ color: risk.risk_level === "High" ? "red" : "green" }}>
//             {risk.risk_level}
//           </p>
...
//           <p>Next Month: {Math.round(cashFlow.nextMonthForecast)}</p>
//         </div>
