...
// //         const res = await axios.get("http://localhost:5000/api/vendors", { headers: { Authorization: `Bearer ${token}` }});
// //         setVendors(res.data);
...
// //     try {
// //       const token = localStorage.getItem("token");
// //       await axios.post("http://localhost:5000/api/vendors", { name }, { headers: { Authorization: `Bearer ${token}` }});
// //       setName("");
// //       const res = await axios.get("http://localhost:5000/api/vendors", { headers: { Authorization: `Bearer ${token}` }});
// //       setVendors(res.data);
// //     } catch (err) { console.log(err); }
